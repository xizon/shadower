                            ...
                            <div class="container t-c">
                                    <div class="row">
                                        <div class="col-sm-8 col-sm-offset-2">
                                            ...
                                            <?php if ( $caption ) { ?>
                                            <p class="h5 font-normal level level-2">									
                                                <span class="uix-slideshowhow-custom-caption" style="color:<?php echo esc_attr( $caption_color ); ?>"><?php echo shadower_wp_kses( $caption ); ?></span>
                                            </p>
                                            <?php } ?>
                                            
                                            <?php if ( $url ) { ?>
                                                <a class="button button-hover button-border-medium button-size-s level level-3" href="<?php echo esc_url( $url ); ?>" title="<?php the_title_attribute(); ?>" target="<?php echo esc_attr( $url_target ); ?>"><?php echo shadower_wp_kses( $button_text ); ?></a>
                                            <?php } ?>
