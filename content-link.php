            ...
            <div class="pos-vertical-align t-c">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                            ...
                            <h3><a href="<?php echo esc_url( get_post_meta( get_the_ID(), 'cus_post_ex_link', true ) ); ?>" target="_blank"><i class="fa fa-external-link" style="color: rgba(255,255,255,.7);"></i></a></h3>
                    </div>
                </div>
                <!-- .row end -->
    ...
    <div <?php post_class( array( 'topics-item', 'style-1', 'scroll-reveal', ( ( !has_post_thumbnail() ) ? esc_attr( 'no-featured-img' ) : '' ) ) ); ?> id="post-<?php the_ID(); ?>">
        <div class="row">
                ...
                <div class="title-style-fieldset">
                     <?php the_title( sprintf( '<h4><a href="%s" target="_blank">', esc_url( get_post_meta( get_the_ID(), 'cus_post_ex_link', true ) ) ), '</a></h4>' ); ?>
                ...
                <?php if ( has_post_thumbnail() ) { ?>
                    <div class="col-sm-6 topics-item-img transition">
                         <a href="<?php echo esc_url( get_post_meta( get_the_ID(), 'cus_post_ex_link', true ) ); ?>" target="_blank">
                            <?php
                ...
                <div class="share transition">
                    <?php echo shadower_wp_kses( shadower_share_buttons( get_post_meta( get_the_ID(), 'cus_post_ex_link', true ), get_the_title() ) ); ?>
                </div>     
