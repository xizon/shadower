	...
	class Featured_Image_Column {
		...
		function settings_page() {
			...
			<div class="wrap">
				...
				<h2><?php echo shadower_wp_kses( __( 'Featured Image Column', 'shadower' ) ); ?></h2>
						...
						<tbody>
							<tr valign="top">	
								<th scope="row" valign="top">
									<?php echo shadower_wp_kses( __( 'Allowed Post Types', 'shadower' ) ); ?>
								</th>
								<td>								
									...
									<span class="description"><?php echo shadower_wp_kses( __( 'By default all post types that support "thumbnails" are selected.', 'shadower' ) ); ?></span>
								</td>
							</tr>
						</tbody>
					</table>
		...
		function columns( $columns ) {
			...
			foreach( $columns as $key => $title ) {
				if ( $key == 'title' ) // Put the Thumbnail column before the Title column
					$new['featured-image'] = shadower_wp_kses( __( 'Image', 'shadower' ) );
