    ...
    class gallery_metabox {
        ...
        function render() {
                        ...
                        foreach ( $attachments as $attachment_id ) {
                            if ( wp_attachment_is_image ( $attachment_id  ) ) {
                                echo '<li class="image" data-attachment_id="' . $attachment_id . '"><div class="attachment-preview"><div class="thumbnail">
                                            ...
                                            <a href="#" class="uix-gmb-remove" title="' . esc_attr__( 'Remove image', 'shadower' ) . '"><div class="media-modal-icon"></div></a>
                                        </div></li>';
                            }
                        }
                    } ?>
            ...
            <p class="add_gallery_images hide-if-no-js">
                <a href="#" class="button-primary"><?php echo shadower_wp_kses( __( 'Add/Edit Images', 'shadower' ) ); ?></a>
            </p>
            ...
            <p>
                <label for="easy_image_gallery_link_images">
                    <input type="checkbox" id="easy_image_gallery_link_images" value="on" name="easy_image_gallery_link_images"<?php echo $checked; ?> /> <?php echo shadower_wp_kses( __( 'Enable Lightbox for this gallery?', 'shadower' ) ); ?>
                </label>
            </p>
                ...
                jQuery(document).ready(function($){
                    ...
                    jQuery( '.add_gallery_images' ).on( 'click', 'a', function( event ) {
                        ...
                        image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                            ...
                            title: "<?php echo shadower_wp_kses( __( 'Add Images to Gallery', 'shadower' ) ); ?>",
                            button: {
                                text: "<?php echo shadower_wp_kses( __( 'Add to gallery', 'shadower' ) ); ?>",
                            },
                            multiple: true
                        });
                                     ...
                                     $gallery_images.append('\
                                        <li class="image" data-attachment_id="' + attachment.id + '">\
                                            <div class="attachment-preview">\
                                               ...
                                               <a href="#" class="uix-gmb-remove" title="<?php esc_attr_e( 'Remove image', 'shadower' ); ?>"><div class="media-modal-icon"></div></a>\
                                            </div>\
                                        </li>');
                                }
                            } );
...
if ( is_admin() ) {
    $gallery_metabox = new gallery_metabox(
		array(
			'id'         => 'gallery-metabox',
			'title'      => __( 'Image Gallery', 'shadower' )
		)
	);
}