...
/**
 * Widget for displaying Team Section
 *
 */
if ( !class_exists( 'Shadower_Team_Widget' ) ) {
	
	class Shadower_Team_Widget extends WP_Widget {
	
		public function __construct() {
			$widget_ops = array(
				'classname' => 'widget_team_section',
				'description' => shadower_wp_kses( __( 'Add a team section for your site.', 'shadower' ) ),
				'customize_selective_refresh' => true,
			);
			parent::__construct( 'team_section', shadower_wp_kses( __( 'Home Section: Team', 'shadower' ) ), $widget_ops );
		}
		...
		public function widget( $args, $instance ) {
			...
			global $default_data;
			$widget_demodata_team = $default_data[ 'sc-home-sections' ][ 'team' ];
			
			
			$title  = apply_filters( 'widget_title', !isset( $instance['title'] ) ? ''.shadower_wp_kses( __( 'Our Team', 'shadower' ) ).'' : $instance['title'], $instance, $this->id_base );
			...
			$content = isset( $instance['content'] ) ? shadower_wp_kses( $instance['content'] ) : $widget_demodata_team;
	...
	[/uix_container]
			...
			echo "\n".'<div data-homepage-widgets-title="'.esc_attr__( 'Team', 'shadower' ).'"></div>'."\n<!-- ".shadower_wp_kses( __( 'End Section', 'shadower' ) )." -->\n\n";
			...
			?>
				...
				<div class="custom-tab-group" id="custom-tab-group-<?php echo $this->id; ?>">
					...
					<div class="item">
						...
						<p>
						<a href="javascript:" class="custom-button uix_sc_form_team_grid-widget_btn" data-target="<?php echo esc_attr( $this->get_field_id('content') ); ?>"><i class="dashicons dashicons-plus"></i><?php echo shadower_wp_kses( __( 'Add new', 'shadower' ) ); ?></a>
						...
						<p>
						   <textarea style="display:none" id="demo-content-<?php echo esc_attr( $this->get_field_id('content') ); ?>"><?php echo $widget_demodata_team; ?></textarea>
