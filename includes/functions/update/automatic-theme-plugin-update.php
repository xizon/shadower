...
/******************Change this*******************/
$api_url = 'https://uiux.cc/wp-themes/'.UIX_THEME_SLUG.'/update/';
/************************************************/
...
add_filter('pre_set_site_transient_update_themes', 'uix_theme_check_for_update');

function uix_theme_check_for_update($checked_data) {
...
add_filter('themes_api', 'uix_theme_api_call', 10, 3);

function uix_theme_api_call($def, $action, $args) {
